...
\begin{frame}[fragile]{Kiwi café: a first recipe}
    ...
    (\href{https://github.com/paultcochrane/git_course/blob/master/git/examples/edmonds-chocolate-cake.md}{\beamerbutton{link}}):
...
\section{Side note: concerning repositories}
