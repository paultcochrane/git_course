...
git rebase --continue
\end{lstlisting}
    See: \resizebox{0.9\textwidth}{!}
        {\url{https://stackoverflow.com/questions/6217156/break-a-previous-commit-into-multiple-commits}}.
\end{frame}
...
%stopzone
    See: \resizebox{0.9\textwidth}{!}
        {\url{https://stackoverflow.com/questions/953481/find-and-restore-a-deleted-file-in-a-git-repository}}
\end{frame}
...
%stopzone
    ...
    See: \resizebox{0.9\textwidth}{!}
        {\url{https://stackoverflow.com/questions/10099258/how-can-i-recover-a-lost-commit-in-git}}
\end{frame}
...
Or use \ttt{Glog} from vim-fugitive in vim:
