...
\begin{frame}{What should you get out of this course?}
    The main thing to get out of this course is:

    \centerline{%
        \includegraphics[width=\textwidth]{images/dont_panic_wallpaperaccess_com.png}
    }

    Git can seem like a complex beast at times.

    My advice: stay calm and don't panic.

    {\tiny Image credits: \url{https://wallpaperaccess.com/download/dont-panic-3629535}}
\end{frame}
