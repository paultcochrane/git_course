...
this course, you'll need a few things:
    \begin{itemize}
        ...
        \item Git installed on your laptop.  See the installation
            ...
            \end{itemize}
        \item Python installed on your laptop.  See the installation
            instructions for your OS:
            \begin{itemize}
                \item \hyperlink{installing_python_windows}{\beamergotobutton{Windows}}
                \item \hyperlink{installing_python_mac}{\beamergotobutton{Mac}}
                \item \hyperlink{installing_python_linux}{\beamergotobutton{Linux}}
            \end{itemize}
    \end{itemize}
\end{frame}
