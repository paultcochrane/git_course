...
\begin{itemize}
  ...
  \item Create a new branch 'yellow' and checkout that branch.
  \item You can do it with\\
        \hlcommand{git branch yellow}\\
        \hlcommand{git checkout yellow}\\
        or in one step:
        \hlcommand{git checkout -b yellow}
  \item Create a file 'yellow.txt' in your yellow branch (you know the content).
        Stage and commit the changes.
  \item Checkout master. Create and checkout a 'red' branch and change the content of 'red.txt' to:\\
        \texttt{red is my favorite color}
  \item Checkout master. Create and checkout a 'blue' branch and change the content of 'blue.txt' to:\\
       \texttt{blue is a cool color}
  \item Check out master and change the content of 'blue.txt' to:\\
...
\end{lstlisting}
(adds a remote with the symbolic name 'andreas')
\end{frame}
...
\begin{itemize}
  ...
  \item Remove the first line in 'green.txt', stage and commit the change.
\pause
